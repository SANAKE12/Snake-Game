(function () {
    ...
    const canvasFillColor = "#1f242d";
    const canvasStrokeColor = "#0ef";
    ...
    // Text Start
    const drawText = (text, x, y, fontSize = "30px", color = "#0ef", align = "center") => {
    ...
    const animate = () => {
        ...
        if (gameActive) {
            ...
            drawText("Press control keys to start", w / 2, h / 2, "20px", "#0ef");
        }
